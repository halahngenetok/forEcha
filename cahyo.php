...
<meta name="description" content="HTML Garud.id">

</head>
<body>

   <!-- Ganti Audio di sini -->
   <audio src="kepompong.mp3" id="linkmp3" class="sembunyi"></audio>

   <div id="bodyblur">
     <!-- Wallpaper --><img src="image.png" id="wallpaper"/><div id="beneranblur"></div>
   </div>
   ...
   <div id='Content'>
     ...
     <div class="kumpulanstiker">
         <!-- Stiker untuk Konten -->
         <img src="https://github.com/user-attachments/assets/21fef29b-6b9c-4a0b-a655-fc3caaaeedf9" id="fotostiker"/>
     ...
     <div><blockquote id='bq' data-text='Gar'>
       <p id="kalimat">Aku Ada Sesuatu Nih 🤣</p>

       <p id="pesan1">Klik 4 emojis di Bawah! 😆</p>
       <div id="kolombaru">
         <li id="lv1">😃</li>
         <li id="lv2">😄</li>
         <li id="lv3">😁</li>
       ...
       <p id="pesan2">Bentar...</p>
       <!-- Pesan -->
       <p id="pesan3">Ciee.. Ada yang Ultah Nih 🤣</p>
       <p id="pesan4">Happy Birthday, </p>
       <p id="pesan5" class="gaya2">Dah nambah tua setahun aja,awokawok</p>
       <p id="pesan6" class="gaya2">Moga panjang umur biar tiap tahun bisa traktirin aku awokawok 😆</p>
       <p id="pesan7" class="gaya2">sehat selalu ngihh,seng ati-ati</p>

       <p id="pesan8" class="gaya2">Canda wkwwk :v</p>
       <p id="pesan9" class="gaya2">semoga kedepannya selalu sehat trs ngihh, dan bisa njaga 30 juz nya,wkwkwk 
       <p id="pesan10" class="gaya2">Happy Level Up Day!! 
